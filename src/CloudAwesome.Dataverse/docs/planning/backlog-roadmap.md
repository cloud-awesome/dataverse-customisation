...
### 0. User authentication functionality
...
- Data migration consultant activating/deactivating processes locally
- Consultant generating security role assignment manifest for import.

While the current authentication methods work very well for automated pipelines, we need to add manual usage before progressing to next steps.
